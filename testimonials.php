...
define( 'TESTIMONIALS_VERSION', '0.6.0' );
...
require_once TESTIMONIALS_DIR . 'includes/class-csv-parser.php';
require_once TESTIMONIALS_DIR . 'includes/class-importer.php';
require_once TESTIMONIALS_DIR . 'includes/class-import-admin-page.php';
